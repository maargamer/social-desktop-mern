...
const isActive = (history, path) => {
    if (history.location.pathname === path) {
        return { borderBottom: "4px solid #ffff", color: "white" }
    } else {
        return { color: "#ffffff" }
    }
}
...
const Menu = (props) => (
    ...
    >
        <a className="navbar-brand" style={{ color: "white", fontFamily: 'Courgette, cursive' }} href="/">
            <i className="fas fa-search mr-2"></i>Maarweb
        </a>
        ...
        <ul className="navbar-nav ml-auto">
            ...
            <Link className="nav-link" style={isActive(props.history, "/streams")} to='/streams' >
                <i className="fas fa-stream mr-1"></i>stream
                </Link>
                </li>
